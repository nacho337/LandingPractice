...
function FourSection() {
  ...
  const words = data['section-six'].title.split(' ');
  ...
  return (
    <div className="mt-0 sm:mt-14">
      ...
      >
        <img
          id="image1"
          src={data['section-six'].image1}
          alt={data['section-six'].alt1}
          width="35%"
          height="auto"
        ...
        <div className="flex flex-col gap-2 mt-6 sm:mt-0">
          ...
          >
            {data['section-six'].subtitle}
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
              id="image2"
              src={data['section-six'].image2}
              alt={data['section-six'].alt2}
              className="hidden sm:block sm:w-full px-4 sm:px-0 h-[92%] object-cover mx-auto col-span-2 sm:col-span-1"
            />
            <img
              id="image3"
              src={data['section-six'].image3}
              alt={data['section-six'].alt3}
